...
.\"
The where-clause specifies a subset of records to be retrieved.
If no where-clause is given, a cross product of all records
in all projected relations will be retrieved.
.IP
The where-clause is made up of expressions comparing the value
